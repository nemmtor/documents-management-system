import { CreateDocumentAggregatePayloadDataBuilder } from './__test-utils__/create-document-aggregate-payload.data-builder';
import { ReconstituteDocumentAggregatePayloadDataBuilder } from './__test-utils__/reconstitute-document-aggregate-payload.data-builder';
...
const aCreateDocumentAggregatePayload = () =>
  new CreateDocumentAggregatePayloadDataBuilder();
const aReconstituteDocumentAggregatePayload = () =>
  new ReconstituteDocumentAggregatePayloadDataBuilder();
