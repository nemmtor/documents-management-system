...
describe('ContractAggregate', () => {
  ...
  describe('hasAttachmentWithId', () => {
    it('returns true if attachment is found', () => {
      const contractAggregate = new ContractAggregate({
        id: '1',
        createdAt: new Date(),
        isSigned: false,
      ...
      const result = contractAggregate.hasAttachmentWithId('1');

      expect(result).toBe(true);
    });

    it('returns true if attachment is not found', () => {
      const contractAggregate = new ContractAggregate({
        id: '1',
        createdAt: new Date(),
        isSigned: false,
      ...
      const result = contractAggregate.hasAttachmentWithId('2');
